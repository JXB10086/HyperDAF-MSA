...
workspace=/root/HyperDAF-MSA/experiments/fair_baseline/lnln_gpu_smoke10_workspace
...
"$python_bin" -u train.py --config_file configs/train_mosi_gpu_smoke10.yaml --seed 1111 > "$log_dir/train_gpu_smoke10.log" 2>&1
return_code=$?
